...
export const FEATURED_PROJECTS: FeaturedProject[] = [
  {
    ...
    layoutType: "large",
    tier: "master",
    tierLabel: "Flagship Estate Build",
    imageUrl: new URL('../assets/images/kensington_extension_1786616602763.jpg', import.meta.url).href,
  ...
  {
    id: "battersea-extension",
    title: "Battersea Rear Kitchen Extension & Side Return",
    location: "Battersea, London SW11",
    category: "Kitchen Extension & Side Return",
    year: "2025",
    area: "120 sq m",
    layoutType: "square",
    tier: "mid-tier",
    tierLabel: "Mid-Range Extension",
    imageUrl: new URL('../assets/images/battersea_extension_1786625461131.jpg', import.meta.url).href,
    summary: "A bright, modern rear side-return kitchen extension with industrial black steel bifold doors and polished concrete floor.",
    fullDescription: "Designed for a family terraced home in Battersea, this mid-range project opened up a dark Victorian rear layout into an expansive indoor-outdoor family kitchen and dining zone. We removed the load-bearing party wall using two custom steel RSJ beams, poured a insulated reinforced slab with wet underfloor heating, and installed high-spec slim bifold glass doors.",
    structuralHighlight: "Dual steel RSJ insertion enabling a continuous 6.5m column-free open plan span.",
    duration: "14 Weeks",
    valueRange: "£125k – £175k",
    engineeringSpecs: [
      "Two structural RSJ steel beams installed with structural engineer calculation sign-off",
      "Thermal concrete slab with wet underfloor heating grid",
      "Powder-coated aluminum bifold doors with toughened low-E double glazing",
      "Exposed internal brick feature wall with damp-proof treatment"
    ],
    clientQuote: {
      text: "Infinity delivered our dream kitchen extension on time and exactly within budget. The structural team was tidy, polite, and top quality.",
      author: "David & Sarah Miller",
      role: "Homeowners"
    }
  },
  {
    id: "islington-renovation",
    title: "Islington Victorian Terrace Structural Refit",
    ...
    layoutType: "square",
    tier: "mid-tier",
    tierLabel: "Mid-Range Refit",
    imageUrl: new URL('../assets/images/islington_renovation_1786625492679.jpg', import.meta.url).href,
    summary: "Full structural refurbishment of a three-storey Victorian family home, combining historic restoration with open-plan living.",
    fullDescription: "A complete mid-range internal overhaul of a period property in Islington. The project included structural chimney breast removal across two floors, structural timber joist strengthening, complete electrical rewiring, new central heating with designer radiators, restored original pine flooring, and two bespoke tiled bathrooms.",
    structuralHighlight: "Double chimney breast removal supported by gallows brackets and structural box frames.",
    duration: "18 Weeks",
    valueRange: "£190k – £260k",
    engineeringSpecs: [
      "Chimney breast removal with building control steel bracket approval",
      "100% rewiring and consumer unit installation with NICEIC certificate",
      "Acoustic subfloor insulation and solid wood floor sanding & restoration",
      "New high-efficiency unvented boiler system and twin bathroom fit-out"
    ],
    clientQuote: {
      text: "We were worried about hidden costs during a period house renovation, but Infinity provided a clear fixed-price breakdown and completed everything flawlessly.",
      author: "Hannah & Mark Jenkins",
      role: "Family Homeowners"
    }
  },
  {
    id: "clapham-loft",
    title: "Clapham Dormer Loft Conversion & Master Suite",
    ...
    layoutType: "square",
    tier: "mid-tier",
    tierLabel: "Mid-Range Loft Build",
    imageUrl: new URL('../assets/images/clapham_loft_1786625473353.jpg', import.meta.url).href,
    summary: "Rear dormer loft conversion providing a spacious master bedroom, luxury en-suite bathroom, and built-in eaves storage.",
    fullDescription: "Transforming an underutilized attic space into a sunlit master suite in Clapham. We constructed a timber and slate rear dormer with triple Velux rooflights, installed structural steel floor tele beams to carry modern dead loads, and created a sleek walk-in shower room with custom microcement finishes.",
    structuralHighlight: "Steel ridge beam installation and structural floor joist strengthening.",
    duration: "9 Weeks",
    valueRange: "£85k – £125k",
    engineeringSpecs: [
      "Steel beam installation carrying new loft floor joists without lowering ceiling heights",
      "Zinc-clad rear dormer with slate roof matching existing street frontage",
      "En-suite wetroom with pumped hot water supply and mechanical extraction",
      "Built-in bespoke wardrobe joinery fitted into roof eaves"
    ],
    clientQuote: {
      text: "Added incredible space and value to our home in less than 10 weeks! Couldn't be happier with the loft finish.",
      author: "Tom Davies",
      role: "Clapham Resident"
    }
  },
  {
    id: "richmond-remodel",
    title: "Richmond Ground Floor Family Remodel",
    location: "Richmond, London TW9",
    category: "Ground Floor Remodel",
    year: "2024",
    area: "140 sq m",
    layoutType: "square",
    tier: "mid-tier",
    tierLabel: "Mid-Range Family Build",
    imageUrl: new URL('../assets/images/richmond_remodel_1786625509818.jpg', import.meta.url).href,
    summary: "Reconfiguration of ground floor living space, utility room addition, and sliding garden door installation.",
    fullDescription: "A smart mid-level structural reconfiguration for a semi-detached house in Richmond. By removing internal partition walls and re-routing main plumbing stacks, we created an open family lounge, dedicated utility room, cloakroom, and broad glass sliding door link to the patio.",
    structuralHighlight: "Structural wall removals creating seamless multi-zone ground floor layout.",
    duration: "12 Weeks",
    valueRange: "£135k – £185k",
    engineeringSpecs: [
      "Steel RSJ lintel insertion over new 4-metre sliding glass door opening",
      "Custom utility room fit-out with acoustic wall lining for washing appliances",
      "Herringbone engineered oak flooring over acoustic underlay",
      "Smart lighting zones and full plaster skim finish"
    ],
    clientQuote: {
      text: "Transformed how our family lives every day. Infinity gave us practical architectural advice that saved us money without sacrificing style.",
      author: "Claire & Simon O'Connor",
      role: "Homeowners"
    }
  },
  {
    id: "mayfair-commercial",
    title: "Mayfair Commercial Headquarters Fit-Out",
    ...
    layoutType: "square",
    tier: "master",
    tierLabel: "Master Commercial Build",
    imageUrl: new URL('../assets/images/mayfair_commercial_1786616614606.jpg', import.meta.url).href,
  ...
  },
  {
    ...
    layoutType: "square",
    tier: "master",
    tierLabel: "Master Subterranean Build",
    imageUrl: new URL('../assets/images/belgravia_basement_1786616625155.jpg', import.meta.url).href,
  ...
  },
  {
    ...
    title: "Chelsea Heritage Structural Rebuild",
    ...
    layoutType: "tall",
    tier: "master",
    tierLabel: "Master Rebuild",
    imageUrl: new URL('../assets/images/chelsea_residential_1786616639607.jpg', import.meta.url).href,
...
export const INSIGHT_ARTICLES: InsightArticle[] = [
  ...
  },
  {
    ...
    readTime: "4 min read",
    imageUrl: new URL('../assets/images/hero_luxury_extension_1786616587617.jpg', import.meta.url).href,
